...
public abstract class BaseAttributeSourceGenerator<T> : IDependencyModuleSourceGenerator
{
    ...
    )
    {
        ...
        var models = incrementalValueProvider
            .Collect()
            .Combine(CollectModels(context, attributeTypes));
    ...
    private void WrapGenerateSourceOutput(
    ...
    private void WrapReportDiagnostics(
        SourceProductionContext context,
        (
            (
                ImmutableArray<(
    ...
    /// </remarks>
    protected virtual void ReportDiagnostics(
        SourceProductionContext context,
        (
            ImmutableArray<(
                ModuleEntryPointModel Left,
    ...
    protected abstract T GenerateAttributeModel(
        GeneratorAttributeSyntaxContext arg1,
